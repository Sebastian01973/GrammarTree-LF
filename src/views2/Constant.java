...
public class Constant {
    ...
    public static final String WORD_VALIDATE = "La palabra si pertenece";
    public static final String WORD_INVALIDATE = "La palabra no pertenece";

    public static final String GRAMMAR_SIMBOL = "G";

    public static final String BUTTON_TEXT = "Validar";
